                    ...
                    <ul
                        ...
                        <li class='max-lg:border-b max-lg:py-3 px-3'>
                            <NavLink to={"/"} href='javascript:void(0)'
                                class='lg:hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>Home</NavLink>
                        </li>
                        <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/team"} href='javascript:void(0)'
                            class='lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]'>Team</NavLink>
                        </li>
                        <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/feature"} href='javascript:void(0)'
                            class='lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]'>Feature</NavLink>
                        </li>
                        <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/blog"} href='javascript:void(0)'
                            class='lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]'>Blog</NavLink>
                        </li>
                        <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink href='javascript:void(0)'
                            class='lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]'>About</NavLink>
                        </li>
                    </ul>
                </div>
